...
De facto the real only Android camera program, as all the other
are toys as they can't even be controlled from a terminal like
any normal non-toy program.

This program is a core component of
[DogeOS](
...
GNU Affero General License version 3.
